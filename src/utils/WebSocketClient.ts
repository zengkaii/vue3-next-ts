...
export default class WebSocketClient {
  ...
  token: string
  constructor(public connectionUrl: string, getToken?: () => string, clientType = 'client') {
  ...
  registerUserHandle(
    type: string,
    handle: (message: StompJs.Message) => any,
    handleId: string = this.handleIdCreate(type, handle)
  ) {
